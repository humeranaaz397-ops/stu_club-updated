...
def patch_admin():
    ...
    new_li = '\n      <li><a href="/admin/withdrawals"><i class="fa-solid fa-money-bill-transfer"></i><span> Withdrawals</span></a></li>'
    
    for fname in files:
        if fname == 'withdrawals.html':
            continue
        ...
        if '/admin/withdrawals' in content:
            continue
